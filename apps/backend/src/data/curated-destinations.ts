...
export const curatedDestinations: DestinationInsert[] = [
  // --- Skigebiete ---
  {
    name: 'Zermatt – Matterhorn ski paradise',
    type: 'ski_resort',
    canton: 'VS',
    lat: 46.0207,
    lng: 7.7491,
    elevationBaseM: 1620,
    elevationTopM: 3883,
    wikipediaTitle: 'Zermatt',
    sourceRef: { curated: true },
  },
  {
    name: 'Saas-Fee',
    type: 'ski_resort',
  ...
  },
  {
    ...
    elevationTopM: 1463,
    sacDifficulty: 'T2',
    wikipediaTitle: 'Creux du Van',
    sourceRef: { curated: true },
  },
  {
    name: 'Aletschgletscher (Bettmerhorn)',
    type: 'hike_destination',
    canton: 'VS',
    lat: 46.4,
    lng: 8.05,
    elevationTopM: 2647,
    sacDifficulty: 'T2',
    wikipediaTitle: 'Aletschgletscher',
    sourceRef: { curated: true },
  },
  {
    name: 'Saxer Lücke',
